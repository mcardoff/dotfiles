...
(custom-set-variables
 ...
 '(package-selected-packages
   '(projectile all-the-icons-ivy-rich all-the-icons-ivy ivy-rich magit elfeed-goodies elfeed cl-lib cl-libify cuda-mode auctex ivy all-the-icons doom-modeline yasnippet use-package tramp smex rainbow-mode org-journal org-bullets org-alert multiple-cursors move-text hasklig-mode haskell-mode gruber-darker-theme ein diminish counsel command-log-mode auto-complete airline-themes)))
(custom-set-faces
