...
(setq org-agenda-files "~/school/agenda/Test.org")
...
;;; Reddit Stuff
(defvar subreddit-list '(("emacs+linux+emacs+me_irl" "megawanxl1")))
...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (cuda-mode which-key company airline-themes ivy micgoline diminish evil-visual-mark-mode smart-mode-line-powerline-theme smart-mode-line magit spotify editorconfig wolfram-mode auto-complete move-text org-bullets multiple-cursors hindent flymake-haskell-multi flymake-hlint flymake-easy powerline hasklig-mode haskell-mode gruber-darker-theme smex)))
 '(tool-bar-mode nil)
 '(whitespace-style
   (quote
...
(custom-set-faces
 ...
 '(window-divider-first-pixel ((t (:foreground "#181818"))))
 '(window-divider-last-pixel ((t (:foreground "#181818")))))
